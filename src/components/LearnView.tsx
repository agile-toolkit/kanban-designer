...
export default function LearnView() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <div className="card">
        <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">{t('learn.principles_title')}</h2>
        <ol className="space-y-2">
          {PRINCIPLES.map((p, i) => (
            <li key={p} className="flex gap-3 text-sm text-gray-600 dark:text-gray-400">
